...
const slides = [
  ...
  },
  {
    ...
    description: "Real-time help across devices",
  },
  {
    id: "3",
...
// Web-friendly onboarding screen without lottie-react-native
        ...
        <FlatList
          ...
          renderItem={({ item }) => (
            <View style={{ width: windowWidth }} className="items-center justify-center p-6">
              <Image source={item.image} style={{ width: windowWidth, height: 300, resizeMode: "contain" }} />
          ...
          <View className="flex flex-row flex-wrap items-center justify-center gap-2">
            <View className="w-full flex-row gap-2">
              <Pressable
                ...
                className="flex-1 border border-black dark:border-white rounded-full flex flex-row items-center justify-center py-4"
              >
            ...
            <Pressable
              ...
              className="flex-1 w-1/4 bg-black dark:bg-white rounded-full flex flex-row items-center justify-center py-4"
            >
